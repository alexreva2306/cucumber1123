...
public class OpenMRSREgisterPage {
    ...
    public void sendName (String name, String familyName) throws InterruptedException {
        ...
        this.familyName.sendKeys(familyName);Thread.sleep(3000);
        nextButton.click();
    }

    public void sendGender (String gender) throws InterruptedException {
        BrowserUtils.selectBy(selectGender,gender,"text");Thread.sleep(3000);
        nextButton.click();
    }
    ...
    public void sendBirthDate(String day, String month, String year) throws InterruptedException {
        ...
        birthYear.clear();
        birthYear.sendKeys(year);Thread.sleep(3000);
        nextButton.click();
    }

    public void sendAddress(String address) throws InterruptedException {
        this.address.sendKeys(address);Thread.sleep(3000);
        nextButton.click();
    }
    public void sendPhoneNumber(String phoneNumber) throws InterruptedException {
        this.phoneNumber.sendKeys(phoneNumber);Thread.sleep(3000);
        nextButton.click();
    }
    ...
    public void sendRelativeInfo(String relationType,String relativeName) throws InterruptedException {
        ...
        this.relativeName.sendKeys(relativeName);Thread.sleep(3000);
        nextButton.click();
    }

    public void clickConfirmButton() throws InterruptedException {Thread.sleep(3000);
        confirmButton.click();
    }
